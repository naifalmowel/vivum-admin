          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(data['title'] ?? 'No Title', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),
                  const SizedBox(height: 4),
                  Row(
                    children: [
                      const Icon(Icons.location_on_outlined, size: 12, color: Colors.grey),
...
class _ProjectFormDialogState extends State<ProjectFormDialog> {
  ...
  late TextEditingController _titleCtrl, _industryCtrl, _challengeCtrl, _solutionCtrl, _resultCtrl, _techCtrl;
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final data = {
        ...
        'colors': _primaryColors.map((c) => c.value).toList(),
        'imageUrls': finalUrls,
      ...
      VivumToast.show(context, 'Error: $e', isError: true);
    } finally {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildField(_industryCtrl, lp.t('proj.industry'), Icons.business, theme),
              const SizedBox(height: 16),
